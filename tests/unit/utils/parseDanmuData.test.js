...
describe('Danmu Data Parsing', () => {
  // 测试数据文件路径
  const testDataPath = resolve(__dirname, '../../data/danmuTestDataSimplified.txt')
  ...
  it('should assign default values for missing fields', () => {
    // 创建一个模拟的不完整数据行
    const mockData = 'type@=chatmsg/rid@=123456/uid@=7890/nn@=测试用户/txt@=测试内容@S/cid@=abc123/ic@=avatar@Sdefault@S01/'
